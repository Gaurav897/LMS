...
class AuthController extends Controller
{
    ...
    public function register(Request $request) {
        $validator = Validator::make($request->all(), [
            ...
            'age' => 'required|regex:/^([0-9\s\-\+\(\)]*)$/|min:2',
            'gender' => 'required|max:5|regex:/^[a-zA-ZÑñ\s]+$/',
    ...
    public function deleteuser($id)
    {
        ...
        if($del!='')
        {
            if($del->delete())
            {
                ...
                return Response("Unable To Remove User");
            }
        }
        else{
            return Response("User Not Available In Record Table");
        }
    }
}